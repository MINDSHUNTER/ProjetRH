...
export declare const getChildren: <T extends TwingBaseNode<any, TwingBaseNodeAttributes, TwingBaseNodeChildren>>(node: T) => Array<[KeysOf<TwingNodeChildren<T>>, TwingNodeChildren<T>[any]]>;
