...
export declare const createUnaryNodeFactory: <InstanceType extends TwingBaseUnaryNode<any>>(type: TwingNodeType<InstanceType>, definition: {
    execute: (operand: TwingBaseExpressionNode, executionContext: TwingExecutionContext) => Promise<any>;
}) => (operand: TwingBaseExpressionNode, line: number, column: number) => InstanceType;
