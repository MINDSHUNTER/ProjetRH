...
export declare const createBinaryNodeFactory: <InstanceType extends TwingBaseBinaryNode<any>>(type: TwingNodeType<InstanceType>, definition: {
    execute: (left: TwingBaseExpressionNode, right: TwingBaseExpressionNode, executionContext: TwingExecutionContext) => Promise<any>;
}) => (operands: [TwingBaseExpressionNode, TwingBaseExpressionNode], line: number, column: number) => InstanceType;
